...
export class ErpController {
    ...
    getMovements(@Param('companyId') companyId: string, @Query('year') year?: number, @Query('month') month?: number) {
    ...
    getQuotes(@Param('companyId') companyId: string, @Query('year') year?: number, @Query('month') month?: number) {
    ...
    getAccounting(@Param('companyId') companyId: string, @Query('year') year?: number, @Query('month') month?: number) {
    ...
    createStockItem(@Param('companyId') companyId: string, @Body() data: any) {
        return this.erpService.createStockItem(companyId, data);
    }
    ...
    updateStockItem(@Param('id') id: string, @Body() data: any) {
        return this.erpService.updateStockItem(id, data);
    }
    ...
    deleteStockItem(@Param('id') id: string) {
        return this.erpService.deleteStockItem(id);
    }
    ...
    getInvoices(@Param('companyId') companyId: string, @Query('year') year?: number, @Query('month') month?: number, @Query('search') search?: string) {
    ...
    createInvoice(@Param('companyId') companyId: string, @Body() data: any) {
        return this.erpService.createInvoice(companyId, data);
    }
    ...
    updateInvoice(@Param('id') id: string, @Body() data: any) {
        return this.erpService.updateInvoice(id, data);
    }
    ...
    deleteInvoice(@Param('id') id: string) {
        return this.erpService.deleteInvoice(id);
    }
    ...
    getPurchaseOrders(@Param('companyId') companyId: string, @Query('year') year?: number, @Query('month') month?: number) {
    ...
    getAttendances(@Param('companyId') companyId: string, @Query('year') year?: number, @Query('month') month?: number) {
    ...
    getLeaveRequests(@Param('companyId') companyId: string, @Query('year') year?: number, @Query('month') month?: number) {
    ...
    getTasks(@Param('companyId') companyId: string, @Query('year') year?: number, @Query('month') month?: number) {

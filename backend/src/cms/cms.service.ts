...
export class CmsService {
  ...
  async updateServices(companyId: string, services: any[]) {
    ...
    for (const s of services) {
      const service = await this.prisma.service.findFirst({ where: { title: s.title } });
      if (!service) {
  ...
  async seedContent(companyId: string) {
    ...
    await this.updateHero(companyId, {
      ...
      subtitle:
        'Leader régional en solutions télécoms et énergétiques. Nous connectons les communautés avec excellence et innovation pour un développement durable.',
      tagline: 'Excellence & Innovation',
      imageUrl:
        'https://images.unsplash.com/photo-1542382103-b09e8432b49c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80',
    });

    await this.updateAbout(companyId, {
      title: "Une Expertise Reconnue en Afrique de l'Ouest",
      description:
        "Fondée avec la vision de transformer le paysage technologique africain, notre entreprise s'est imposée comme un partenaire incontournable pour les opérateurs télécoms et les acteurs de l'énergie. Notre approche combine expertise technique de pointe, connaissance approfondie du terrain et engagement sans faille envers la qualité.",
      vision: 'Devenir le référent panafricain des infrastructures intelligentes et durables.',
      mission:
        'Accompagner la transformation numérique et énergétique du continent par des solutions robustes.',
    ...
    await this.updateRealizations(companyId, {
      ...
      gallery: [
        {
          caption: 'Site Solaire Hybride',
          category: 'Energie',
          imageUrl:
            'https://images.unsplash.com/photo-1542382103-b09e8432b49c?auto=format&fit=crop&w=800&q=80',
        },
        {
          caption: 'Pylône 4G Rural',
          category: 'Telecom',
          imageUrl:
        ...
        },
        {
          ...
          category: 'Telecom',
          imageUrl:
            'https://images.unsplash.com/photo-1544197150-b99a580bbc7c?auto=format&fit=crop&w=800&q=80',
        },
      ],
    });
    ...
    await this.updateCareers(companyId, {
      ...
      subtitle: 'Carrières',
      description:
        "Nous recherchons des talents passionnés pour relever les défis technologiques de demain. Chez ENEA, vous trouverez un environnement stimulant propice à l'innovation.",
      contactEmail: 'jobs@eneagroup.com',
      openings: [
        {
          title: 'Ingénieur Télécom Senior',
          location: 'Abidjan',
          type: 'CDI',
          description: 'Expertise en RAN 4G/5G et transmission micro-ondes.',
        },
        {
          title: 'Technicien Fibre Optique',
          location: 'Bouaké',
          type: 'CDD',
          description: 'Tirage, raccordement et mesure de câbles FO.',
        },
        {
          title: 'Chef de Projet Déploiement',
          location: 'Dakar',
          type: 'CDI',
          description: 'Gestion de rollout, planning et coordination sous-traitants.',
        },
      ],
    });
    ...
    await this.updateSeo(companyId, {
      ...
      metaDescription:
        "ENEA Group est spécialisé dans le déploiement d'infrastructures télécoms, d'énergie et de génie civil en Afrique de l'Ouest.",

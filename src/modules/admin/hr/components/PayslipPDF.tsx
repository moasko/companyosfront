...
export const PayslipPDF: React.FC<Props> = ({ payslip, employee }) => {
    const periodStr = new Date(payslip.period + '-01').toLocaleDateString('fr-FR', { month: 'long', year: 'numeric' });
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.header}>
                    <View style={styles.companyInfo}>
                        ...
                        <Text style={{ fontSize: 8, color: '#64748b', marginTop: 10 }}>Cocody Riviera 3, Abidjan</Text>
                    ...
                    <View>
                        ...
                        <Text style={[styles.documentSub, { fontSize: 8 }]}>Émis le: {new Date(payslip.date).toLocaleDateString()}</Text>
                    </View>
                </View>
                ...
                <View style={styles.grid}>
                    ...
                    <View style={styles.gridCol}>
                        ...
                        <Text style={{ fontSize: 8, marginTop: 4 }}>Date d'entrée: {new Date(employee.joinDate).toLocaleDateString()}</Text>
                    </View>
                </View>
                ...
                <View style={styles.totalSection}>
                    <View style={styles.totalBox}>
                        ...
                        <View style={styles.totalRow}>
                            ...
                            <Text style={styles.totalValue}>{(payslip.grossSalary - payslip.netSalary).toLocaleString()} CFA</Text>
                        </View>
                ...
                <View style={styles.footer}>
                    ...
                    <View style={styles.signature}>
                        ...
                        <View style={styles.signatureBox} />
                        <Text style={{ fontSize: 7, marginTop: 5, textAlign: 'right', color: '#94a3b8' }}>Généré par ENEA ERP v2.0</Text>
                    </View>
                </View>
            </Page>
        </Document>

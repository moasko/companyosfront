...
import { fetchEmployees, fetchPayslips, updateEmployee, deleteEmployee, createEmployee, createPayslip, fetchAttendances, createAttendance, fetchLeaveRequests, createLeaveRequest, updateLeaveRequest } from '../api/hr.api';
...
export const useHr = (companyId: string, filters?: any) => {
    ...
    return {
        ...
        isLoading: employeesQuery.isLoading || payslipsQuery.isLoading || attendancesQuery.isLoading || leaveRequestsQuery.isLoading,

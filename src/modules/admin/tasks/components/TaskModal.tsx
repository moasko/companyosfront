      ...
      <div className="space-y-6">
        <div className="space-y-4">
          <InputField
            ...
            value={task.title}
            onChange={(v) => onChange({ ...task, title: v })}
            placeholder="Ex: Relancer le client X..."
            autoFocus
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-slate-50 rounded-sm border border-slate-100">
          ...
          <div className="space-y-1.5 text-left text-left">
            <InputField
              label="Catégorie"
              value={task.category || ''}
              onChange={(v) => onChange({ ...task, category: v })}
              placeholder="Ex: Support, Bug, Dev..."
            />
          </div>
        </div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  onChange({
                    ...
                    clientName: c?.companyName || c?.contactName || '',
                  });
                }}
              >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <InputField
                ...
                onChange={(v) => onChange({ ...task, startDate: v })}
              />
              <InputField
                type="number"
                label="Heures Est."

    ...
    <section id="contact" className="py-32 bg-corporate-950 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="mb-20 space-y-6">
          <p className="text-enea-accent font-black uppercase tracking-[0.5em] text-[11px]">
            Contact & Support
          </p>
          ...
          <p className="text-corporate-400 text-xl font-light max-w-2xl mx-auto leading-relaxed">
            Transformez vos projets d'infrastructure en réalités tangibles avec l'expertise d'Enea
            Group.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 mb-20">
          <div className="group bg-white/[0.03] p-12 border border-white/5 hover:border-enea-accent/30 transition-all duration-500">
            ...
            <p className="text-white font-display font-black text-4xl mb-4 tracking-tighter">
              {contact.phone}
            </p>
            <p className="text-corporate-500 font-black uppercase tracking-widest text-xs">
              Appel Direct
            </p>
            <a
              href={`tel:${contact.phone}`}
              className="mt-8 inline-flex px-8 py-3 bg-enea-accent transition-all hover:bg-white hover:text-enea-accent text-[10px] font-black uppercase tracking-widest"
            >
              Appeler Maintenant
            </a>
          </div>
          ...
          <div className="group bg-white/[0.03] p-12 border border-white/5 hover:border-enea-accent/30 transition-all duration-500">
            ...
            <a
              ...
              className="mt-8 inline-flex px-8 py-3 bg-white/10 hover:bg-white hover:text-corporate-950 transition-all text-[10px] font-black uppercase tracking-widest"
            >
              Envoyer un Message
            </a>
          </div>
          ...
          <div className="glass-dark border border-white/5 p-10 lg:p-14 shadow-[0_0_80px_rgba(0,0,0,0.4)] text-left">
            ...
            >
              <div className="space-y-3">
                <label className="text-[10px] font-black uppercase tracking-widest text-corporate-500">
                  Nom Complet
                </label>
                <input
                  type="text"
                  className="w-full bg-white/[0.03] border border-white/10 px-6 py-4 text-white focus:outline-none focus:ring-1 focus:ring-enea-accent transition-all placeholder:text-corporate-700"
              ...
              <div className="md:col-span-2 space-y-3">
                ...
                <textarea
                  rows={4}
                  className="w-full bg-white/[0.03] border border-white/10 px-6 py-4 text-white focus:outline-none focus:ring-1 focus:ring-enea-accent transition-all resize-none placeholder:text-corporate-700"

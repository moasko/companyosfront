          ...
          <div className="relative group">
            <div className="relative aspect-[4/5] overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-10 left-10 right-10 p-8 glass-dark border-white/10 animate-fade-in">
                <p className="text-enea-accent font-black uppercase tracking-[0.3em] text-[10px] mb-2">
                  Engagement Qualité
                </p>
                <p className="text-white text-lg font-medium leading-tight">
                  "L'excellence n'est pas un acte, mais une habitude dans chaque mètre carré que
                  nous construisons."
                </p>
              </div>
            </div>
          ...
          <div className="space-y-12">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-3">
                ...
                <span className="text-xs font-black text-enea-accent uppercase tracking-[0.4em]">
                  À Propos de Nous
                </span>
              </div>
            ...
            <div className="p-10 bg-corporate-50 border border-corporate-100 group hover:border-enea-accent/30 transition-all duration-500">
              ...
              <p className="text-corporate-600 font-light leading-relaxed">{about.values}</p>
            </div>
          </div>
        </div>
      </div>

...
export const CareersSection: React.FC<CareersSectionProps> = ({ careers }) => {
    return (
        <section id="carrieres" className="py-32 bg-white relative overflow-hidden flex flex-col items-center">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
                ...
                <div className="grid gap-8">
                    ...
                    {careers.openings.length === 0 && (
                        <div className="text-center p-24 bg-corporate-50 border-2 border-dashed border-corporate-200">
                            <p className="text-corporate-900 font-display font-black text-3xl mb-4 uppercase tracking-tight">Opportunités à Venir</p>
                            <p className="text-corporate-500 font-light max-w-md mx-auto text-lg leading-relaxed">
                                Notre équipe s'agrandit constamment. Envoyez-nous votre candidature spontanée pour nos futurs projets.
                            </p>
                        </div>
                    )}
                </div>
                ...
                <div className="mt-24 p-12 md:p-16 bg-corporate-900 text-center text-white relative overflow-hidden group">
                    ...
                    <p className="text-corporate-500 font-black uppercase tracking-[0.5em] text-[10px] mb-6 relative z-10">Rejoindre l'aventure</p>
                    <p className="text-3xl md:text-4xl font-display font-bold relative z-10 leading-tight">
                        ...
                        Envoyez votre dossier à <a href={`mailto:${careers.contactEmail}`} className="text-enea-accent font-black hover:text-white transition-colors underline-offset-8 decoration-2 decoration-enea-accent/30 hover:decoration-enea-accent">{careers.contactEmail}</a>
                    </p>
                </div>
            </div>

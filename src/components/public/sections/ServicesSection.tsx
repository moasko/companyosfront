            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col items-center text-center mb-24">
                    ...
                    <h3 className="text-5xl md:text-[60px] font-display font-black text-white leading-tight uppercase tracking-tight">
                        SOLUTIONS COMPLETES <br className="hidden md:block" /> POUR VOTRE <span className="text-enea-accent">INFRASTRUCTURE</span>
                    </h3>
                            ...
                            <div className="relative z-10">
                                ...
                                <ul className="space-y-4 pt-8 border-t border-white/5">
                                    {service.features.map((feature, fIdx) => (
                                        <li key={fIdx} className="flex items-center text-xs font-black uppercase tracking-widest text-corporate-500 group-hover:text-corporate-300 transition-colors">

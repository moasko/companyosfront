...
export const HeroSection: React.FC<HeroSectionProps> = ({ content, onCtaClick, onSecondaryClick }) => {
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden bg-corporate-950">
            {/* Background Image & Effects */}
            <img
                src={content.hero.imageUrl || "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1920&q=80"}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full py-20">
                <div className="max-w-4xl space-y-10 animate-fade-in-up">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-0 pt-4">
                        ...
                        >
                            <span className="text-base md:text-lg font-black uppercase tracking-widest relative z-10">Démarrer Projet</span>
                        ...
                        >
                            <span className="text-base md:text-lg font-black uppercase tracking-widest">Expertises</span>
            ...
            <div className="absolute bottom-10 right-0 z-20 hidden lg:flex items-center gap-8 origin-bottom rotate-[-90deg] translate-y-[-50%]">
                <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40 whitespace-nowrap">SCROLL TO EXPLORE</span>
